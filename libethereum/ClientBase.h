...
protected:
	...
	std::shared_ptr<TransactionQueue> m_tq;	///< Maintains a list of incoming transactions not yet in a block on the blockchain. This is never null. Only stored in this object.
